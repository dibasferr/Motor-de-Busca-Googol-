...
javac -encoding UTF-8 -cp ".;target/lib/jsoup-1.21.2.jar" -d target/classes -sourcepath src/main/java src/main/java/search/*.java
if %errorlevel% neq 0 (
    echo.
...
javadoc -encoding UTF-8 -docencoding UTF-8 -charset UTF-8 -d docs -cp ".;target/lib/jsoup-1.21.2.jar" src/main/java/search/*.java
if %errorlevel% neq 0 (
    echo.
